...
#         presets = {
#             "angry": VoiceSettings(0.3, 0.8, 0.6, True),
#             "arrogant": VoiceSettings(0.6, 0.9, 0.7, True),
#             "soft": VoiceSettings(0.7, 0.7, 0.3, True),
#             "cold_hearted": VoiceSettings(0.6, 0.8, 0.2, False),
#             "nice": VoiceSettings(0.8, 0.8, 0.5, True),
#             "analytical": VoiceSettings(0.75, 0.7, 0.3, True),
#             "neutral": VoiceSettings(0.5, 0.75, 0.0, True),
#         }
...
#         except Exception:
#             logger.error("❌ ElevenLabs TTS failed", exc_info=True)
